 ...
 */
public class MIUISetActivity extends UmengAgentActivity {
...
//        guideTitle.setText(getString(R.string.miui_setting_title));
//        guideTitle.setTextColor(Color.WHITE);
        TextView guideMessage = (TextView) findViewById(R.id.device_menu_set);
        guideMessage.setText(getString(R.string.miui_setting_message));
        ImageView guideImage = (ImageView) findViewById(R.id.guide_image);
        guideImage.setImageResource(R.drawable.tips_miui);
        ...
        guideNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MIUISetActivity.this, AppMessageSetting.class);
                startActivity(intent);
                MIUISetActivity.this.finish();
            }
        });
    }
